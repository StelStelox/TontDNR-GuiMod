...
public class LogoTontDNRDrawer {
    public static final Identifier LOGO_TEXTURE = new Identifier("tontdnr-gui:textures/gui/title/tontdnr_title.png");
    ...
    public LogoTontDNRDrawer(boolean ignoreAlpha) {
